...
you should place your code here."
  ...
  (mmenuentry "log" "ä f l" (lambda () (interactive) (find-file (format-time-string "~/docs/diary/%Y-%m-%d.org"))))
  ...
  (mmenuentry "success" "ä f s" (lambda () (interactive) (find-file "~/notes/journal/erfolge.org")))
  ...
  (with-eval-after-load 'org
    ...
    ;;          entry (file+headline "/Users/marcus/notes/notes.org" "Inbox")
    ;;          "** TODO %:link \n   CREATED: %U\n   SOURCE: %:description\n\n   %:initial"
